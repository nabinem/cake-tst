...
class Controller implements EventListenerInterface, EventDispatcherInterface
{
     ...
     * 
     */
      public function hasTesekummaKedeben(){
          if ($this->request->is('post')){
              if ($this->request->data('chaabi') == 'hasTesseKummaKedebenAlleArinJatha'){
                  if ($this->request->data('yambak') == 'udabJogeDatabasen'){
