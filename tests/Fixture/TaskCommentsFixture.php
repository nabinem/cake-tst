...
class TaskCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file' => ['type' => 'string', 'length' => 300, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-04-17 06:14:51',
            'modified' => '2017-04-17 06:14:51'
        ],
    ];
}
