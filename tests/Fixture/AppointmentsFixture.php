...
class AppointmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'appt_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'appt_date' => '2017-07-22 03:10:17',
            'user_id' => 1,
            'doctor_id' => 1,
            'is_confirmed' => 1,
            'created_by' => 1,
            'created' => '2017-07-22 03:10:17',
            'modified' => '2017-07-22 03:10:17'
        ],
    ];
}
