...
class LeadStatusesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lead_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-02 07:08:42',
            'modified' => '2016-11-02 07:08:42'
        ],
    ];
}
