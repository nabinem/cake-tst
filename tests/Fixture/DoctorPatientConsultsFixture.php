...
/**
 * DoctorPatientConsultsFixture
 *
 */
class DoctorPatientConsultsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'doc_verfy_text' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'doctor_id' => 1,
            'patient_id' => 1,
            'doc_verfy_text' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-03-21 17:38:58',
            'modified' => '2017-03-21 17:38:58'
        ],
    ];
}
